...
export class MetadataClient {
    ...
    public getTask(callback:(error:net.Error,response:net.Response) => void,
          taskName:string) {
    ...
    public updateTask(callback:(error:net.Error,response:net.Response) => void,
          taskDef:TaskDef) {
    ...
    public createTasks(callback:(error:net.Error,response:net.Response) => void,
          taskDef:TaskDef) {
    ...
    public deleteTask(callback:(error:net.Error,response:net.Response) => void,
          taskType:string) {
    ...
    public updateWorkflows(callback:(error:net.Error,response:net.Response) => void,
    ...
    public createWorkflow(callback:(error:net.Error,response:net.Response) => void,
          name:string) {
